...
int convertDecToBinary(int);

int main(){
    // Write a C function to convert Decimal to Binary number system.
    ...
    */
    ...
    printf("%d (decimal) = %d (binary)", decimal_number, convertDecToBinary(decimal_number));

    return 0;
}

int convertDecToBinary(int decimal){
    int quotient, remainder, index = 0, binary = 0;
    quotient = decimal;
