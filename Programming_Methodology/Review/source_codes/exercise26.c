...
// ==== Main function ====
void subtract_two_matrices(int (*first_matrix)[MAX_SIZE], int (*second_matrix)[MAX_SIZE], 
                        int (*subtraction_matrix)[MAX_SIZE], int num_of_rows, int num_of_cols);

int main(){
    // Write program to subtract to matrices
    ...
    int first_matrix[MAX_SIZE][MAX_SIZE],
        ...
        subtraction_matrix[MAX_SIZE][MAX_SIZE];
    ...
    subtract_two_matrices(first_matrix, second_matrix, subtraction_matrix, num_of_rows, num_of_cols);

    // Result
    printf("\nAddition matrix: \n");
    print_matrix(subtraction_matrix, num_of_rows, num_of_cols);
    return 0;
}
